		...
		<div id="p">
			...
			<div id="y">
				...
				<div><%=user.getMember_name()%><br><%=user.getMember_id()%><br>
					...
					%>
					<a href="/member/myPage?mode=email">등록</a>
					<%
					} else {
					%>
					<%=user.getEmail()%><a href="/member/myPage?mode=email"><br>변경</a>
					<%
					}
					%>
				</div>
			...
			<div id="y">
				...
				<div>
					<%=user.getHeart_count()%>
					개<br> <a href="/member/myPage?mode=post"><%=user.getPost_count()%> 개</a><br>
					<a href="/member/myPage?mode=reply"><%=user.getReply_count()%> 개</a><br>
				</div>
			</div>
			<%
			}
